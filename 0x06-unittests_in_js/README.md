...
tosmel@ADNEGS~$ npm test 0-calcul.test.js
...
Terminal 1
```
tosmel@ADNEGS:~/8-api$  node api.js
API available on localhost port 7865
```
Terminal 2
```
tosmel@ADNEGS:~/8-api$  curl http://localhost:7865 ; echo ""
Welcome to the payment system
tosmel@ADNEGS:~/8-api$  
tosmel@ADNEGS:~/8-api$ npm test api.test.js
...
Terminal 1
```
tosmel@ADNEGS:~$ node api.js
API available on localhost port 7865
```
Terminal 2
```
tosmel@ADNEGS:~$ curl http://localhost:7865/cart/12 ; echo ""
Payment methods for cart 12
tosmel@ADNEGS:~$ 
tosmel@ADNEGS:~$ curl http://localhost:7865/cart/hello -v
*   Trying 127.0.0.1...
* TCP_NODELAY set
...
Terminal 2
```
tosmel@ADNEGS:~$ curl http://localhost:7865/available_payments ; echo ""
{"payment_methods":{"credit_cards":true,"paypal":false}}
tosmel@ADNEGS:~$ 
tosmel@ADNEGS:~$ curl -XPOST http://localhost:7865/login -d '{ "userName": "Betty" }' -H 'Content-Type: application/json' ; echo ""
Welcome Betty
tosmel@ADNEGS:~$ 
```
Tips:
